<html>
	...
	<body>
		...
		<div class="row">
			<div class="col-md-6">
				<a href="<@s.url value="/backend/jobs/-/edit" />" class="btn btn-default col-md-3"><@s.text name="button.main.add" /></a>
			</div>
			<div class="col-md-6">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td><a href="<@s.url value="/backend/jobs/${job.id!}/edit" />">${job.name!}</a></td>
										...
										<td>
											...
											&nbsp;&nbsp;&nbsp;
											<a href="" title="<@s.text name="label.job.action.delete" />" ng-bootbox-confirm="<@s.text name="message.job.delete.confirm" />" ng-bootbox-confirm-action="confirm('${job.id!}')">
